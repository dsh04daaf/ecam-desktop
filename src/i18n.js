...
(function (global) {
  const DICTS = {
    es: {
      ...
      install_lead_docker: 'ECAM necesita cargar su motor en Docker (imagen arm64 nativa, ~90 MB). Se queda como una imagen aparte y no toca nada más de tu Docker.',
      install_go_docker: 'Cargar la imagen',
      docker_missing: 'Docker no responde. Instala Docker Desktop o Colima, arráncalo y vuelve a esta pantalla.',
    ...
    en: {
      ...
      install_lead_docker: 'ECAM needs to load its engine into Docker (native arm64 image, ~90 MB). It stays as a separate image and touches nothing else in your Docker.',
      install_go_docker: 'Load the image',
      docker_missing: 'Docker is not responding. Install Docker Desktop or Colima, start it and come back to this screen.',
    ...
    ru: {
      ...
      install_lead_docker: 'ECAM нужно загрузить движок в Docker (нативный образ arm64, ~90 МБ). Это отдельный образ, остальное в вашем Docker не затрагивается.',
      install_go_docker: 'Загрузить образ',
      docker_missing: 'Docker не отвечает. Установите Docker Desktop или Colima, запустите и вернитесь на этот экран.',
